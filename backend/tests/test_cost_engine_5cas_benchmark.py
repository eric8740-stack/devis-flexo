...
_FIXTURE_CONFIG_COUTS: dict = {
    ...
    # Phase 2 Lot 4a — P1/P3/P4/P6 basculent sur ConfigCouts (anciens
    # TarifPoste marge_confort_roulage_mm=10, cliche_prix_couleur=45,
    # outil_base_eur=200, outil_par_trace_eur=50,
    # surcout_forme_speciale_pct→_facteur=1.40, calage_forfait=225,
    # finitions_prix_m2=0.1250). Snapshot ICE exact pour préserver V1a.
